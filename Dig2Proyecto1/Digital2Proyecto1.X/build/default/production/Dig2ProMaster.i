...
# 28 "Dig2ProMaster.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\c90\\stdint.h" 1 3
# 29 "Dig2ProMaster.c" 2
...
void AHT10_Read(void){
    ...
    data[5] = I2C_Master_Read(1);
    data[6] = I2C_Master_Read(0);
    I2C_Master_Stop();

 temperature = (((uint32_t)data[3] & 0x0F) << 16) + ((uint16_t)data[4] << 8) + data[5];
    temperature = ((temperature/1048576)*200-50);

    floattostr(temperature, buffer, 2);
    Lcd_Set_Cursor(1,12);
